...
function fetchDataAndProcess() {
    return __awaiter(this, void 0, void 0, function () {
        var i, data, res, outputFilePath, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    i = 0;
                    _a.label = 1;
                case 1:
                    if (!(i < PAGES_COUNT)) return [3 /*break*/, 6];
                    _a.label = 2;
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, fetchDataFromApi()];
                case 3:
                    data = _a.sent();
                    console.log(data);
                    if (!data) {
                    ...
                    res = eta.render("./simple", {
                        key: "".concat(data.key),
                        activity: "".concat(data.activity),
                        price: "".concat(data.price),
                        accessibility: "".concat(data.accessibility),
                    });
                    outputFilePath = path.join(__dirname, "output".concat(i, ".html"));
